  ...
  return (
    <div className="mt-32 bg-surface-container-low rounded-xl p-12 md:p-24 text-center border-t border-outline-variant/15">
      ...
      <div className="flex flex-col sm:flex-row gap-6 justify-center">
        <button className="bg-primary-container text-on-primary-container px-10 py-4 rounded-lg font-medium text-lg scale-100 hover:scale-105 active:scale-95 transition-transform">Sign Up for Access</button>
        <button className="border border-outline text-primary px-10 py-4 rounded-lg font-medium text-lg hover:bg-surface-container-high transition-colors scale-100 hover:scale-105 active:scale-95 transition-transform">Sign In</button>
      </div>
    </div>
  );
};
